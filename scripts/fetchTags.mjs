...
async function main() {
  try {
    ...
    // poll-tags mapping
    const urlPollTags =
      'https://raw.githubusercontent.com/PulseMakerWin/community/master/governance/polls/meta/poll-tags.json';
    ...
    //poll tags
    const urlTags =
      'https://raw.githubusercontent.com/PulseMakerWin/community/master/governance/polls/meta/tags.json';
