            ...
            <BoxWithClose close={() => setOverlayOpen(false)}>
              ...
              >
                ...
                <Text as="p" sx={{ mb: 3 }}>
                  ...
                  finding the one with the highest pMKR voting weight in relative terms.
                </Text>
                <Text as="p" sx={{ mb: 3 }}>
                ...
                <Text as="p">
                  ...
                  finding the one with an absolute majority in pMKR voting weight, being &gt;50% of the total
                  participating pMKR (excluding abstains).
                </Text>
              </Flex>
            </BoxWithClose>
          </DialogContent>
