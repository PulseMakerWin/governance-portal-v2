...
export const POLLS_HASH_FILE_URL = {
  ...
  [SupportedNetworks.TENDERLY]:
    'https://raw.githubusercontent.com/PulseMakerWin/community/tenderly-polls/governance/polls/meta/hashed-polls.json'
};
...
export const AGGREGATED_POLLS_FILE_URL = {
  ...
  [SupportedNetworks.TENDERLY]:
    'https://raw.githubusercontent.com/PulseMakerWin/community/tenderly-polls/governance/polls/meta/polls.json'
};
