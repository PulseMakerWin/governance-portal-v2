...
export const icons = {
  ...
  chevron_down: daiUiIcons.chevron_down,
  chevron_up: daiUiIcons.chevron_up,
  checkmark: daiUiIcons.checkmark,
  dots_h: daiUiIcons.dots_h,
  question_o: daiUiIcons.question_o,
  lock: daiUiIcons.lock,
  ...
  PulseChain: brandIcons.PulseChain,
  play: {
    path: (
      <g>
        <path
  ...
  mkr_locked: {
    path: (
      <g>
        <path
          d="M4.27844 13.8288H4.42844V13.6788V11.5931L5.93806 12.7292V13.6788V13.8288H6.08806H6.5501H6.7001V13.6788V12.5583C6.7001 12.4265 6.63815 12.3023 6.53283 12.2231L4.33818 10.5715C4.06171 10.3635 3.66641 10.5607 3.66641 10.9067V13.6788V13.8288H3.81641H4.27844Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M10.0575 13.8288H9.9075V13.6788V11.5931L8.39787 12.7292V13.6788V13.8288H8.24787H7.78584H7.63584V13.6788V12.5583C7.63584 12.4265 7.69779 12.3023 7.8031 12.2231L9.99776 10.5715C10.2742 10.3635 10.6695 10.5607 10.6695 10.9067V13.6788V13.8288H10.5195H10.0575Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M11.0696 7.09168V4.23245C11.0696 2.25157 9.35556 0.640625 7.24822 0.640625C5.1407 0.640625 3.42684 2.24952 3.42684 4.23245V7.09944C2.32717 7.90646 1.51076 9.04025 1.09422 10.3391C0.67765 11.6378 0.682276 13.035 1.10754 14.3309C1.5328 15.6268 2.35666 16.7552 3.46179 17.5548C4.56678 18.3543 5.89617 18.7842 7.26021 18.7827C8.62414 18.7814 9.95274 18.3489 11.0562 17.5471C12.1596 16.7453 12.9813 15.6152 13.4038 14.3184C13.8264 13.0216 13.8282 11.6244 13.4091 10.3263C12.9898 9.02839 12.1711 7.89623 11.0698 7.09151L11.0696 7.09168ZM4.61495 4.23245C4.61495 2.90601 5.79535 1.82891 7.24825 1.82891C8.70129 1.82891 9.88155 2.90792 9.88155 4.23245V6.40219C9.05387 6.03386 8.15812 5.84353 7.25204 5.84353C6.3461 5.84353 5.45036 6.03388 4.62267 6.40219V4.23245H4.61495ZM7.25409 17.5939C5.85375 17.5933 4.51103 17.0366 3.52106 16.0461C2.53116 15.0557 1.97536 13.7125 1.9756 12.3121C1.97601 10.9118 2.53252 9.56899 3.52294 8.57902C4.51325 7.58912 5.85625 7.03304 7.25667 7.03318C8.65709 7.03332 9.99987 7.58968 10.9901 8.57999C11.9802 9.57017 12.5364 10.9132 12.5364 12.3134C12.5344 13.7134 11.9771 15.0556 10.9869 16.0454C9.99674 17.0351 8.6543 17.5919 7.25423 17.5935L7.25409 17.5939Z"
          fill="currentColor"
        />
      </g>
    ),
  ...
  discord_outline: {
    path: (
      <path
        d="M11.345 1.58495C11.127 0.978951 10.907 0.367951 10.903 0.359951C10.798 0.124951 10.555 -0.0230489 10.299 0.00295113C10.137 0.0159511 6.304 0.345951 3.848 2.32095C2.564 3.50695 0 10.441 0 16.436C0 16.542 0.027 16.645 0.08 16.737C1.851 19.847 6.679 20.661 7.779 20.696C7.786 20.697 7.792 20.697 7.798 20.697C7.992 20.697 8.174 20.604 8.29 20.447L9.48 18.835C7.514 18.536 7.159 18.146 7.076 18.085C6.632 17.758 6.304 17.3 6.702 16.722C7.008 16.273 7.65 16.125 8.142 16.378C8.646 16.613 9.995 17.369 14 17.349C17.977 17.337 19.723 16.504 19.748 16.486C20.416 16.185 20.937 16.309 21.262 16.755C21.649 17.362 21.373 17.773 20.931 18.099C20.848 18.16 20.647 18.331 18.535 18.831L19.71 20.446C19.825 20.604 20.008 20.696 20.202 20.696C20.209 20.696 20.215 20.696 20.221 20.695C21.322 20.66 26.15 19.846 27.92 16.736C27.973 16.644 28 16.541 28 16.435C28 10.441 25.436 3.50695 24.12 2.29495C21.696 0.346951 17.863 0.0169511 17.701 0.00295113C17.445 -0.0190489 17.202 0.125951 17.097 0.359951C17.093 0.367951 16.879 0.988951 16.672 1.58795C16.672 1.58795 15.041 1.34895 14 1.34895C12.959 1.34895 11.345 1.58495 11.345 1.58495ZM10 14.349C8.895 14.349 8 13.016 8 11.37C8 9.72395 8.895 8.39095 10 8.39095C11.109 8.22595 11.976 9.72395 12 11.37C12 13.016 11.105 14.349 10 14.349ZM18 14.349C16.895 14.349 16 13.007 16 11.352C16 9.69695 16.895 8.35495 18 8.35495C19.105 8.35495 20 9.69695 20 11.352C20 13.007 19.105 14.349 18 14.349Z"
        fill="currentColor"
        fillOpacity="0"
        stroke="currentColor"
      />
  ...
  stats: {
    path: (
      <g>
        <path
          d="M0.552865 0.416855C0.312176 0.443418 0.131602 0.649234 0.136829 0.891225V8.83674V8.83657C0.135037 8.96156 0.183599 9.08199 0.271272 9.17113C0.359109 9.2601 0.478884 9.31013 0.603873 9.31013C0.729026 9.31013 0.848801 9.2601 0.936475 9.17113C1.02431 9.08199 1.07271 8.96156 1.07092 8.83657V0.891062V0.891225C1.07385 0.756619 1.01861 0.627558 0.919366 0.536626C0.820125 0.445857 0.686499 0.402183 0.55287 0.416851L0.552865 0.416855ZM8.00402 3.6928V3.69297C7.85101 3.71692 7.71966 3.81535 7.65383 3.95566L5.67617 8.12907H3.64015L3.63998 8.12891C3.51499 8.12712 3.39441 8.17552 3.30543 8.26335C3.21646 8.35103 3.16627 8.47097 3.16627 8.59595C3.16627 8.72094 3.21646 8.84072 3.30543 8.92839C3.39441 9.01623 3.51499 9.06463 3.63998 9.06284H5.97533C6.15687 9.06284 6.32194 8.95757 6.39855 8.79281L8.06971 5.26151L11.3902 12.5212C11.4666 12.6894 11.6348 12.7966 11.8196 12.7951C12.0042 12.7935 12.1706 12.6833 12.2441 12.5139L13.7547 9.06269H17.4182C17.5432 9.06448 17.6638 9.01608 17.7527 8.92841C17.8419 8.84057 17.8919 8.7208 17.8919 8.59581C17.8919 8.47082 17.8419 8.35104 17.7527 8.26321C17.6638 8.17553 17.5432 8.12714 17.4182 8.12876H13.4482C13.2622 8.1273 13.0933 8.23615 13.0177 8.40612L11.7989 11.186L8.50028 3.96267C8.41424 3.77152 8.21135 3.66103 8.00405 3.69264L8.00402 3.6928ZM0.552865 10.2233C0.312176 10.2497 0.131602 10.4556 0.136829 10.6975V16.5346C0.136829 16.8411 0.240309 17.1445 0.457858 17.3663C0.675573 17.5881 0.985834 17.702 1.30443 17.702H17.4178C17.5428 17.7037 17.6632 17.6553 17.7522 17.5674C17.841 17.4797 17.8912 17.36 17.8912 17.2352C17.8912 17.1102 17.841 16.9904 17.7522 16.9027C17.6632 16.8149 17.5428 16.7665 17.4178 16.7681H1.30443C1.17928 16.7681 1.14375 16.7393 1.12192 16.7171C1.10024 16.6949 1.07091 16.6531 1.07091 16.5347V10.6976C1.07384 10.5632 1.0186 10.434 0.919357 10.3432C0.820116 10.2524 0.686491 10.2088 0.552862 10.2234L0.552865 10.2233Z"
          fill="currentColor"
        />
      </g>
    ),
  ...
  color_mode_sun: {
    path: (
      <g>
        <path
          d="M10.766 9.06729C13.5205 7.47694 17.0554 8.42473 18.6453 11.1785C20.2352 13.9324 19.2885 17.4675 16.534 19.0579C13.7801 20.6478 10.2446 19.7004 8.65471 16.9466C7.06476 14.1927 8.01215 10.6572 10.766 9.06729ZM16.1222 18.3446C18.4837 16.9813 19.2953 13.9522 17.9319 11.5908C16.5686 9.22939 13.5395 8.41776 11.1781 9.78112C8.81667 11.1445 8.00504 14.1735 9.36841 16.535C10.7318 18.8964 13.7608 19.708 16.1222 18.3446Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M8.70892 5.49793C8.90592 5.38419 9.15847 5.45246 9.2718 5.64875L10.5078 7.78963C10.6212 7.98592 10.554 8.23877 10.357 8.35251C10.16 8.46625 9.90746 8.39798 9.79413 8.20169L8.55809 6.06081C8.44477 5.86452 8.51191 5.61167 8.70892 5.49793Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M16.95 19.7701C17.147 19.6564 17.3996 19.7246 17.5129 19.9209L18.3369 21.3482C18.4503 21.5445 18.3831 21.7974 18.1861 21.9111C17.9891 22.0248 17.7366 21.9566 17.6232 21.7603L16.7992 20.333C16.6859 20.1367 16.753 19.8838 16.95 19.7701Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M5.95809 18.0293L7.38538 17.2052C7.58167 17.0919 7.83494 17.1597 7.94827 17.356C8.06159 17.5523 7.99373 17.8056 7.79744 17.9189L6.37015 18.743C6.17386 18.8563 5.92059 18.7884 5.80727 18.5921C5.69394 18.3959 5.7618 18.1426 5.95809 18.0293Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M19.5167 10.2011L20.944 9.37709C21.141 9.26335 21.3935 9.33162 21.5069 9.52791C21.6202 9.7242 21.553 9.97706 21.356 10.0908L19.9287 10.9148C19.7317 11.0286 19.4792 10.9603 19.3659 10.764C19.2525 10.5677 19.3197 10.3149 19.5167 10.2011Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M4.49339 10.9989C4.58407 10.9465 4.69669 10.9291 4.80621 10.9571L6.94446 11.5295C7.16399 11.5883 7.29539 11.8159 7.23574 12.034C7.17763 12.2531 6.95077 12.3841 6.73122 12.3253L4.59298 11.7529C4.37344 11.6941 4.24246 11.4672 4.3017 11.2484C4.33022 11.1397 4.40141 11.052 4.49352 10.9988L4.49339 10.9989Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M20.43 15.2646C20.5214 15.2118 20.6329 15.1941 20.7428 15.2229L22.3195 15.6447C22.539 15.7035 22.6696 15.9297 22.6107 16.1492C22.5519 16.3688 22.3258 16.4993 22.1062 16.4405L20.5296 16.0186C20.31 15.9598 20.1786 15.7322 20.2383 15.5141C20.2682 15.4046 20.3394 15.3168 20.4301 15.2645L20.43 15.2646Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M11.7189 20.6316C11.8111 20.5784 11.9218 20.5612 12.0318 20.5899C12.2506 20.6491 12.3812 20.8753 12.323 21.0944L12.007 22.2741C11.9481 22.4936 11.722 22.6242 11.5024 22.5654C11.2829 22.5065 11.1523 22.2804 11.2112 22.0608L11.5273 20.8812C11.5565 20.7721 11.6284 20.6839 11.7191 20.6315L11.7189 20.6316Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
        <path
          d="M15.8897 5.09218C15.9811 5.03941 16.0926 5.02172 16.2026 5.05047C16.4221 5.1093 16.5527 5.33544 16.4938 5.55499L16.0265 7.29682C15.9677 7.51636 15.7416 7.64692 15.522 7.5881C15.3025 7.52927 15.1719 7.30313 15.2307 7.08359L15.698 5.34175C15.7273 5.23265 15.7985 5.14487 15.8899 5.09211L15.8897 5.09218Z"
          fill="currentColor"
          stroke="currentColor"
          strokeWidth="0.3"
        />
  ...
  color_mode_moon: {
    path: (
      <path
        d="M1.8152 9.01394C1.8152 12.8731 5.01858 16.0014 8.97019 16.0014C11.3702 16.0014 13.5559 14.8373 14.8697 12.9699C14.6089 12.9943 14.3457 13.0067 14.0811 13.0067C9.56509 13.0067 5.9037 9.43132 5.9037 5.02076C5.9037 4.16146 6.043 3.32107 6.31149 2.52376C3.64474 3.56471 1.81514 6.1092 1.81514 9.01365L1.8152 9.01394ZM7.65248 1.94906C7.1766 2.89675 6.9259 3.94091 6.9259 5.02096C6.9259 8.88012 10.1293 12.0088 14.0809 12.0088C14.6452 12.0088 15.2005 11.945 15.7394 11.8202L16.793 11.576L16.3164 12.5255C14.9527 15.2413 12.1229 17 8.96997 17C4.45391 17 0.792969 13.4248 0.792969 9.01448C0.792969 5.29437 3.41849 2.09165 7.07576 1.24415L8.12936 1L7.65248 1.94906Z"
        fill="currentColor"
        stroke="currentColor"
        strokeWidth="0.1"
      />
  ...
  github: {
    path: (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.0711 0.0898438C5.50479 0.0898438 0.996094 4.59854 0.996094 10.1648C0.996094 14.6178 3.88438 18.3906 7.88592 19.7265C8.38688 19.8192 8.57243 19.51 8.57243 19.2379C8.57243 18.9967 8.56624 18.3658 8.56006 17.5247C5.75836 18.1308 5.16462 16.1764 5.16462 16.1764C4.70695 15.0137 4.04518 14.6983 4.04518 14.6983C3.12984 14.0736 4.11321 14.086 4.11321 14.086C5.12133 14.1602 5.6594 15.125 5.6594 15.125C6.55619 16.665 8.0158 16.2197 8.59098 15.9599C8.68375 15.3105 8.94351 14.8652 9.22801 14.6117C6.99531 14.3643 4.6451 13.4984 4.6451 9.63912C4.6451 8.53823 5.03474 7.64144 5.68414 6.93637C5.579 6.67661 5.23266 5.65613 5.77691 4.27074C5.77691 4.27074 6.62423 3.99861 8.54769 5.3036C9.35171 5.08095 10.2114 4.96962 11.0711 4.96344C11.9246 4.96962 12.7904 5.08095 13.5945 5.3036C15.5179 3.99861 16.3652 4.27074 16.3652 4.27074C16.9157 5.65613 16.5693 6.6828 16.4642 6.93637C17.1074 7.64144 17.497 8.53823 17.497 9.63912C17.497 13.5108 15.1406 14.3581 12.8956 14.6117C13.2543 14.9209 13.5821 15.5394 13.5821 16.4795C13.5821 17.8277 13.5697 18.9101 13.5697 19.244C13.5697 19.5162 13.7491 19.8254 14.2624 19.7265C18.2639 18.3906 21.146 14.6178 21.146 10.171C21.146 4.59853 16.6374 0.0898438 11.0711 0.0898438Z"
        fill="currentColor"
      />
    ),
    viewBox: '0 0 22 20'
  ...
  wechat: {
    path: (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18.7095 14.445C19.9793 13.5243 20.7909 12.1636 20.7909 10.6504C20.7909 7.87904 18.0937 5.63177 14.7674 5.63177C11.441 5.63177 8.74382 7.87904 8.74382 10.6504C8.74382 13.4226 11.441 15.6699 14.7674 15.6699C15.4548 15.6699 16.1181 15.5724 16.7338 15.3949L16.9105 15.3683C17.0263 15.3683 17.1313 15.4041 17.2304 15.4608L18.5495 16.2223L18.6653 16.2598C18.7761 16.2598 18.8661 16.1699 18.8661 16.059L18.8336 15.9124L18.562 14.9L18.5411 14.7717C18.5411 14.6367 18.6078 14.5175 18.7095 14.445ZM8.02139 0.0898438C4.0293 0.0898438 0.792969 2.78623 0.792969 6.11339C0.792969 7.9282 1.7662 9.5622 3.29021 10.6663C3.4127 10.7529 3.49269 10.8962 3.49269 11.0587L3.46769 11.212L3.14189 12.4269L3.10273 12.6027C3.10273 12.736 3.21105 12.8444 3.34354 12.8444L3.48353 12.7994L5.06586 11.8853C5.18418 11.817 5.31 11.7745 5.44916 11.7745L5.66163 11.8061C6.39989 12.0186 7.19648 12.1369 8.02139 12.1369L8.41802 12.1269C8.26137 11.657 8.17554 11.162 8.17554 10.6513C8.17554 7.6174 11.1269 5.15766 14.7674 5.15766L15.1598 5.16765C14.6157 2.29045 11.6269 0.0898438 8.02139 0.0898438ZM12.7592 9.84801C12.3159 9.84801 11.9568 9.48804 11.9568 9.04475C11.9568 8.60063 12.3159 8.2415 12.7592 8.2415C13.2034 8.2415 13.5625 8.60063 13.5625 9.04475C13.5625 9.48804 13.2034 9.84801 12.7592 9.84801ZM16.7755 9.84801C16.3314 9.84801 15.9722 9.48804 15.9722 9.04475C15.9722 8.60063 16.3314 8.2415 16.7755 8.2415C17.2188 8.2415 17.5779 8.60063 17.5779 9.04475C17.5779 9.48804 17.2188 9.84801 16.7755 9.84801ZM5.61164 5.14932C5.07919 5.14932 4.6484 4.7177 4.6484 4.18609C4.6484 3.65364 5.07919 3.22202 5.61164 3.22202C6.14408 3.22202 6.57571 3.65364 6.57571 4.18609C6.57571 4.7177 6.14408 5.14932 5.61164 5.14932ZM10.4303 5.14932C9.89786 5.14932 9.46708 4.7177 9.46708 4.18609C9.46708 3.65364 9.89786 3.22202 10.4303 3.22202C10.9628 3.22202 11.3944 3.65364 11.3944 4.18609C11.3944 4.7177 10.9628 5.14932 10.4303 5.14932Z"
        fill="currentColor"
      />
    ),
    viewBox: '0 0 21 17'
  ...
  email: {
    path: (
      <g>
        <path
          d="M20.7334 7.13406C20.6234 7.07059 20.4986 7.03716 20.3716 7.03716C20.2447 7.03716 20.1199 7.07059 20.0099 7.13406L10.6042 12.4517L1.19854 7.13406C1.05093 7.04879 0.877962 7.01843 0.710185 7.04831C0.542388 7.07802 0.390578 7.1662 0.281245 7.29701C0.172073 7.42783 0.112641 7.59304 0.113286 7.76358V14.0073C0.113286 14.583 0.341966 15.135 0.748945 15.5422C1.15608 15.9492 1.70808 16.1778 2.28383 16.1778H18.9246C19.5004 16.1778 20.0524 15.9492 20.4595 15.5422C20.8665 15.135 21.0952 14.583 21.0952 14.0073V7.76688C21.0963 7.63881 21.0634 7.51269 20.9999 7.40141C20.9363 7.29014 20.8444 7.19793 20.7334 7.13381L20.7334 7.13406Z"
          fill="currentColor"
        />
        <path
          d="M18.9246 0.984375H2.28383C1.70808 0.984375 1.1561 1.21305 0.748945 1.62003C0.341966 2.02717 0.113286 2.57916 0.113286 3.15492V4.51148C0.112802 4.6389 0.145909 4.76439 0.209539 4.87486C0.273009 4.98548 0.364577 5.07721 0.475043 5.14101L10.2425 10.6579C10.3525 10.7214 10.4773 10.7548 10.6042 10.7548C10.7312 10.7548 10.856 10.7214 10.966 10.6579L20.7334 5.14101C20.8439 5.07721 20.9355 4.98548 20.9989 4.87486C21.0626 4.76439 21.0957 4.63891 21.0952 4.51148V3.15492C21.0952 2.57916 20.8665 2.02719 20.4595 1.62003C20.0524 1.21305 19.5004 0.984375 18.9246 0.984375Z"
          fill="currentColor"
        />
      </g>
    ),
  ...
  canny: {
    path: (
      <g>
        <path
          d="M7.50992 19.0898C3.83502 19.0898 0.824219 16.1058 0.824219 12.4398V6.73981C0.824219 3.07384 3.83502 0.0898438 7.50992 0.0898438C10.7739 0.0898438 13.5494 2.42165 14.0884 5.63198C14.1748 6.15016 13.8323 6.63856 13.3141 6.7279C12.7959 6.81426 12.3105 6.46583 12.2212 5.94765C11.834 3.65456 9.88045 1.98983 7.54566 1.98983C4.91903 1.98983 2.80164 4.12211 2.80164 6.73981V12.4398C2.80164 15.0605 4.91903 17.1898 7.54566 17.1898C9.87747 17.1898 11.84 15.525 12.2242 13.2319C12.3105 12.7138 12.7989 12.3653 13.3141 12.4517C13.8323 12.5381 14.1658 13.0294 14.0795 13.5446C13.5464 16.7579 10.7709 19.0898 7.50992 19.0898Z"
          fill="currentColor"
        />
        <path
          opacity="0.5"
          d="M5.39473 10.4448C4.87059 10.4448 4.48047 10.019 4.48047 9.49483V6.74609C4.48047 5.05457 5.84441 3.67871 7.5419 3.67871C8.70035 3.67871 9.74267 4.32197 10.2728 5.35833C10.511 5.82588 10.3234 6.39766 9.85583 6.63591C9.38828 6.87415 8.81352 6.68951 8.57528 6.22196C8.37277 5.8229 7.94989 5.57572 7.50914 5.57572C6.85992 5.57572 6.31196 6.09986 6.31196 6.74312V9.49185C6.30899 10.019 5.91886 10.4448 5.39473 10.4448Z"
          fill="currentColor"
        />
      </g>
    ),
  ...
  lightningBolt: {
    ...
    path: (
      <g>
        <path
          d="M1.00003 14C0.836855 14 0.683965 13.9205 0.590422 13.7868C0.496784 13.6532 0.474238 13.4824 0.530041 13.3291L2.2862 8.49986H0.500012C0.371551 8.49986 0.248002 8.45042 0.154924 8.3618C0.0619549 8.27307 0.00670834 8.15209 0.000571143 8.02374C-0.00556719 7.89539 0.0379602 7.7696 0.122112 7.67239L6.62216 0.172232C6.72395 0.0549292 6.87462 -0.0084636 7.02977 0.000910878C7.1849 0.0101745 7.32686 0.0910899 7.41391 0.21989C7.50097 0.348575 7.52329 0.51041 7.47418 0.657842L5.69391 5.99967H7.50007C7.63054 5.99967 7.75587 6.05067 7.84919 6.14186C7.9426 6.23304 7.99662 6.35704 7.99986 6.48752C8.00298 6.61788 7.9551 6.74445 7.86626 6.8401L1.36621 13.8402C1.27168 13.942 1.13897 14.0001 1.00003 14ZM1.595 7.49987H3.00004C3.16321 7.49964 3.31621 7.57922 3.40987 7.71282C3.50351 7.84652 3.52595 8.01751 3.47003 8.17074L2.31354 11.3505L6.35357 6.99986H5.0001C4.83938 6.99997 4.68838 6.92262 4.59441 6.79226C4.50044 6.66179 4.47499 6.49403 4.526 6.34168L5.73015 2.72847L1.595 7.49987Z"
          fill="currentColor"
        />
      </g>
    )
