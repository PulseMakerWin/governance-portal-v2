      ...
      <SidebarLayout>
                ...
                {chiefBalance?.gt(0) && (
                  <Flex sx={{ alignItems: 'flex-start', flexDirection: 'column', mt: 5 }}>
                    <Text as="p">
                      ...
                      <Text sx={{ fontWeight: 'bold' }}>{formatValue(chiefBalance, 'wad', 6)} pMKR.</Text>
                      <Text as="p" sx={{ my: 2 }}>
                        {voteDelegateContractAddress
                          ? 'As a delegate you can only vote with your delegate contract through the portal. You can withdraw your pMKR and delegate it to yourself to vote with it.'
                          : 'If you become a delegate, you will only be able to vote through the portal as a delegate. In this case, it is recommended to withdraw your pMKR and delegate it to yourself or create the delegate contract from a different account.'}
                      </Text>
                    </Text>
                    <Withdraw sx={{ mt: 3 }} />
                  </Flex>
        ...
        <Stack gap={3}>
          {addressInfo && addressInfo.delegateInfo && (
            <Box>
              <ErrorBoundary componentName="Delegate pMKR">
                <ManageDelegation
                  delegate={addressInfo.delegateInfo}
                  textDelegate="Delegate pMKR to myself"
                  textUndelegate="Undelegate pMKR from my contract"
                />
              </ErrorBoundary>
            </Box>
          )}
